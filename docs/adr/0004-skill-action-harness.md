...
Flag drift fails CI. Skills cannot silently point at removed scripts. Live SageMaker e2e remains out of scope. Makefile/gitleaks from the closed validation pack are not required for this ADR.
