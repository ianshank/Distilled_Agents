...
def validate_training_data(data_file: str):
    ...
    for i, line in enumerate(lines, 1):
        try:
            ...
            if "prompt" in data and "completion" in data:
                ...
                if any(
                    word in prompt for word in ["architecture", "system design", "infrastructure"]
                ):
                    ...
                    word in prompt for word in ["deploy", "terraform", "kubernetes", "docker"]
                ):
    ...
    print(
        f"📝 Average completion length: {total_completion_length / valid_examples:.1f} characters"
    )
...
def demo_sample_predictions():
    ...
    print("📝 Sample prompts that the agent will learn to handle:")
    for i, prompt in enumerate(sample_prompts, 1):
        print(f"  {i}. {prompt}")

    print("\n💡 Expected capabilities after training:")
    print("  ✅ Code generation for various frameworks")
    print("  ✅ Infrastructure as Code (Terraform, Kubernetes)")
    print("  ✅ System architecture design")
    print("  ✅ Security and authentication patterns")
    print("  ✅ Testing and monitoring strategies")
    print("  ✅ Database design and optimization")
    print("  ✅ API design and implementation")
...
def main():
    ...
    if data_valid and config_valid:
        ...
        print("   python training/train_software_dev_agent.py")
        print("\n📚 For more options:")
        print("   python training/train_software_dev_agent.py --help")
    else:
