    ...
    for role in expected_roles:
        ...
        if os.path.exists(training_file):
            try:
                ...
                logger.debug("Skipping unreadable training report %s", training_file)
        ...
        if os.path.exists(eval_file):
            try:
                ...
                logger.debug("Skipping unreadable evaluation report %s", eval_file)
        ...
        if os.path.exists(registration_file):
            try:
                ...
                logger.debug("Skipping unreadable registration report %s", registration_file)
