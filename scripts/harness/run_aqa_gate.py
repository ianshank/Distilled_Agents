#!/usr/bin/env python3
"""AQA Regression Gate: Single-pass pass_rate regression gate.

Runs golden sets and enforces single-pass pass_rate thresholds.
For multi-trial unbiased Pass@K evaluation (Chen et al.), use
