# OpenSpec (Distilled_Agents)

Thin coordination layer. Authoritative behavior lives in ADRs,
`docs/README_AGENT_DISTILLATION.md`, and CI. See `project.md`.

## Active programme: symbolic KD
