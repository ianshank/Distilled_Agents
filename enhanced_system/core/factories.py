...
class ValidatorFactory:
    ...
    @staticmethod
    def create(config: dict[str, Any], logger: Optional[logging.Logger] = None) -> InputValidator:
        """
...
class AdaptiveRouterFactory:
    ...
    @staticmethod
    def create(config: dict[str, Any], logger: Optional[logging.Logger] = None) -> AdaptiveRouter:
        """
...
class BatchProcessorFactory:
    ...
    @staticmethod
    def create(config: dict[str, Any], logger: Optional[logging.Logger] = None) -> BatchProcessor:
        """
...
class MonitorFactory:
    ...
    @staticmethod
    def create(config: dict[str, Any], logger: Optional[logging.Logger] = None) -> AgentMonitor:
        """
