...
class ABTestFramework:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        logger.info(
            f"ABTestFramework initialized (enabled: {self.enabled})"
        )
    ...
    def analyze_experiment(self, experiment_id: str) -> Dict[str, Any]:
        ...
        control_samples = sum(
            len(values) for values in experiment.control_variant.metrics.values()
        )
    ...
    def _generate_recommendation(
        ...
        if winner == 'treatment':
            ...
            return (
                "Recommend keeping control model. "
                "Treatment does not show significant improvements."
            )
        else:
            return (
    ...
    def get_experiment_status(self, experiment_id: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            'control_samples': sum(
                len(v) for v in experiment.control_variant.metrics.values()
            ),
            'treatment_samples': sum(
                len(v) for v in experiment.treatment_variant.metrics.values()
            ),
